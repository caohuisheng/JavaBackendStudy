package com.chs.springdoc.config;
...
public class SwaggerConfig {
    ...
    public GroupedOpenApi group1() {
        return GroupedOpenApi.builder().group("group1")
                .packagesToScan("com.chs.springdoc.controller")
                .pathsToMatch("/**")
                .build();
    }
    ...
    public GroupedOpenApi group2() {
        return GroupedOpenApi.builder().group("group2")
                .packagesToScan("com.chainup.exchange.api")
                .packagesToExclude("com.chs.springdoc.controller")
                .pathsToMatch("/test/**")
                .build();
    }
