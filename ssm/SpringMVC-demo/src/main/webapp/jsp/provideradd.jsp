...
<div class="right">
        ...
        <p>${message}</p>
         <input type="hidden" value="${pageContext.request.contextPath}" id="path">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/pro/providerSave.do" enctype="multipart/form-data">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                    ...
                    <input type="button"  id="bfiles" value="点我上传"> 
                    <input type="file" name="phonefiles" id="files" style="display: none">
