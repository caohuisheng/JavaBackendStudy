 ...
 */
public class AuthLinkLevel3 extends AuthLink {

    private Date beginDate = sdf.parse("2024-10-01 00:00:00");
    private Date endDate = sdf.parse("2024-10-30 23:59:59");

    public AuthLinkLevel3(String authUserId, String authUserName) throws ParseException {
